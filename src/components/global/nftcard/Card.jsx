export const Card = ({ url, userName, text, price }) => {
  return (
    <div className="flex flex-col items-start rounded-2xl border-[0.7px] border-light-border bg-white tablet:h-full">
      <div className="flex p-2 self-stretch tablet:h-[11.25rem]">
        <img
      ...
      <div className="flex flex-col px-3 pb-3 pt-1 gap-2 self-stretch tablet:px-4 tablet:flex-grow tablet:gap-3">
