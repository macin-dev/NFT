export const WhiteButton = ({ content }) => {
  return (
    <button className="flex items-center justify-center gap-2 text-sm font-normal h-11 py-3 px-5 rounded-xl tracking-[-0.012rem] self-stretch bg-light-surface-secondary-btn text-light-element-primary tablet:self-start">
      {content}
      <svg
        width="14"
        height="14"
