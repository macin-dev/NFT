        ...
        <ButtonContainer />
          <FourImagesGrid height="h-[15rem] tablet:h-[20.5rem]" squareBorder={true}>
              <div className="flex flex-col gap-1.5 mt-7 tablet:mt-9 tablet:gap-2.5">
                  <ImageItem url="/assets/home1.jpeg" width="w-[6.438rem] tablet:w-[8.863rem]" height="h-[6.438rem] tablet:h-[8.863rem]"/>
                  <ImageItem url="/assets/home4.jpeg" width="w-[6.438rem] tablet:w-[8.863rem]" height="h-[6.438rem] tablet:h-[8.863rem]"/>
              </div>
              <div className="flex flex-col gap-1.5 tablet:gap-2.5">
                  <ImageItem url="/assets/home2.jpeg" width="w-[6.438rem] tablet:w-[8.863rem]" height="h-[6.438rem] tablet:h-[8.863rem]"/>
                  <ImageItem url="/assets/home3.jpeg" width="w-[6.438rem] tablet:w-[8.863rem]" height="h-[6.438rem] tablet:h-[8.863rem]"/>
              </div>
          </FourImagesGrid>
          <RedRectangle/>
      </div>
